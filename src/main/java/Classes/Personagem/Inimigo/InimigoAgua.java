...
public class InimigoAgua extends Inimigo{
    ...
    public InimigoAgua(int hpMaximo, int manaMaxima, int colldownDeAtaque) {
        ...
        this.dialogoVitoria.add("Na programação quando você quer impor uma condição a algo utilizamos a estrutura [IF], essa estrutura é bastante útil podendo ser utilizada para comparar variáveis, verificar se uma variavél possui determinado valor...");
        ...
        this.dialogoVitoria.add("Você é merecedor do meu pergaminho, pegue.");
        this.dialogoVitoria.add("Adeeeeeeus :D");
    }
